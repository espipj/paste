...
export const DataVizColorSwatches: React.FC<React.PropsWithChildren<unknown>> = () => {
...
export const PieChartCaption: React.FC<React.PropsWithChildren<unknown>> = () => (
  <ImageCaption>
...
export const LineChartCaption: React.FC<React.PropsWithChildren<unknown>> = () => (
  <ImageCaption>
